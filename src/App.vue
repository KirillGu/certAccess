...
export default {
  ...
  mounted(){
    ...
    if (data === "154723562756@2356238562@35892798347@@6934720982309582305@"){
      ...
      this.np = "45** ***737"
      this.ip = "7* ****344"
      this.numCert = "1000 5702 3314 5811"
    }
  }
};
</script>